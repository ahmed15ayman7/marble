...
const navItems = [
  { href: "/supplier/dashboard", icon: LayoutDashboard, label: "لوحة التحكم", exact: true },
  { href: "/supplier/products", icon: Package, label: "المنتجات" },
  { href: "/supplier/products/add", icon: PlusCircle, label: "إضافة منتج" },
];
