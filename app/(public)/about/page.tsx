...
export const metadata: Metadata = {
  title: "من نحن",
  description: "تعرف على شركة نور الرخام والجرانيت - خبرة تتجاوز 20 عاماً في صناعة الرخام والجرانيت",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-stone-600 dark:text-stone-400 leading-relaxed">
                <p>
                  بدأت شركة نور الرخام والجرانيت رحلتها عام 2004 برؤية واضحة: تقديم أجود أنواع الرخام والجرانيت المصري والمستورد بأسعار تنافسية وخدمة احترافية.
                </p>
                <p>
            ...
            <div className="bg-gradient-to-br from-gold-50 to-stone-100 dark:from-stone-800 dark:to-stone-700 rounded-3xl p-10">
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="text-center bg-white dark:bg-stone-800 rounded-2xl p-5 shadow-sm">
      ...
      <section className="py-16 bg-stone-50 dark:bg-stone-900/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, i) => (
              <div key={i} className="bg-white dark:bg-stone-800 rounded-2xl p-6 text-center border border-stone-100 dark:border-stone-700">
