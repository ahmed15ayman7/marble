...
export const metadata: Metadata = {
  title: "من نحن",
  description: "تعرف على شركة سمارت ماربل والجرانيت - خبرة تتجاوز 20 عاماً في صناعة الرخام والجرانيت",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-stone-600 dark:text-stone-400 leading-relaxed">
                <p>
                  بدأت شركة سمارت ماربل والجرانيت رحلتها عام 2004 برؤية واضحة: تقديم أجود أنواع الرخام والجرانيت المصري والمستورد بأسعار تنافسية وخدمة احترافية.
                </p>
                <p>
